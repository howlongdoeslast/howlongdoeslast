...
export const BButton = ({ link, title }) => {
  return (
    <div className="su-button-center">
      <a href={link} className="su-button" target="_blank" rel="nofollow noopener noreferrer">
      ...
      <tbody className="row-hover">
        {products?.map((product, index) => (
          <tr key={index}>
            ...
            <td className="tb-column">
              <a href={product.link} className="su-button" target="_blank" rel="nofollow noopener noreferrer">
