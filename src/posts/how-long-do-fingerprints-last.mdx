...
rvalue: 5
beforebody: >-
  Every human has a unique fingerprint, but **how long do fingerprints last**?
  We will find out in this article.


  In order for a fingerprint to be useful, it needs to be clear and distinct enough to make an identification. Fingerprints can fade or change due to a number of factors, including age and injury. However, the consensus is that they should at least remain visible for six months after the person’s death.
table:
  table: false
products: []
afterbody: ""
...
|                                     |                |
| ----------------------------------- | -------------- |
| **Fingerprints on**                 | **Last up To** |
| Paper                               | 40 Years       |
| Metal (door handles, gun, car)      | 2.5 Years      |
| Plastic (bags, steering wheel)      | 7 Years        |
| Surface (window, outdoors, clothes) |                |
